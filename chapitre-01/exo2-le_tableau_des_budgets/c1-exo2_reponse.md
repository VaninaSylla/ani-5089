...
| Le compositeur assemble l'image | Quelques millisecondes avant l'affichage |Le compositeur applique TimeWarp ou PhaseSync juste avant le VSync pour corriger la position de la tête. Mesuré à 2–3 ms dans les docs Meta Quest.[github](https://github.com/meta-quest/agentic-tools/blob/main/skills/hz-perfetto-debug/references/frame-timing.md?utm_source=copilot.com) |
...
Les deux premières étapes (capteurs et transmission) restent difficiles à documenter séparément : les constructeurs publient des latences globales (« motion-to-photon latency ») mais pas de valeurs isolées pour la mesure capteur ou la transmission
